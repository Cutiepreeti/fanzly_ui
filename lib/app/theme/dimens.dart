...
abstract class Dimens {
  ...
  static EdgeInsets edgeInsets15_9 =
      EdgeInsets.only(left: fifteen, right: nine);
  static EdgeInsets edgeInsets15_10 = EdgeInsets.only(left: fifteen, top: ten);
  static EdgeInsets edgeInsets15_100 =
      EdgeInsets.only(left: fifteen, right: hundred);
  ...
  static EdgeInsets edgeInsets18_18 =
      EdgeInsets.only(left: Dimens.eighteen, right: eighteen);

  ///padding fromLTRB
  static EdgeInsets edgeInsets10_6_3_10 =
      EdgeInsets.fromLTRB(ten, six, three, ten);
  static EdgeInsets edgeInsets10_6_3_0 =
      EdgeInsets.fromLTRB(ten, six, three, zero);
  static EdgeInsets edgeInsets10_0_3_10 =
      EdgeInsets.fromLTRB(ten, zero, three, ten);
  static EdgeInsets edgeInsets6_6_0_6 =
      EdgeInsets.fromLTRB(six, six, zero, six);
  static EdgeInsets edgeInsets12_0_0_6 =
      EdgeInsets.fromLTRB(twelve, zero, zero, six);
  static EdgeInsets edgeInsets16_16_8_0 =
      EdgeInsets.fromLTRB(sixteen, sixteen, eight, zero);
  static EdgeInsets edgeInsets16_16_0_0 =
      EdgeInsets.fromLTRB(sixteen, sixteen, zero, zero);
  static EdgeInsets edgeInsets18_16_8_16 =
      EdgeInsets.fromLTRB(eighteen, sixteen, eight, sixteen);
  ...
  ///Padding symmetric
  static EdgeInsets edgeInsets15_50 =
      EdgeInsets.symmetric(vertical: Dimens.fifteen, horizontal: Dimens.fifty);
